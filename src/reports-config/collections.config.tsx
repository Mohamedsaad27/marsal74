...
export const collectionsReportConfig: ReportConfig<CollectionItem, CollectionSummary> = {
  ...
  buildKpis: (s) => [
    ...
    { label: "تم تسويتها", value: s.fully_settled_count, icon: CheckCircle2, tone: "success" },
    { label: "نقدية معلقة", value: s.pending_cash_count, icon: Clock, tone: "warning" },
    {
      label: "إجمالي العمولات",
      value: Number(s.total_system_commission_amount),
      icon: Percent,
      tone: "info",
    },
  ],
  ...
  normaliseRow: (item) => ({
    ...
    net_due: Number(item.agent_net_due),
