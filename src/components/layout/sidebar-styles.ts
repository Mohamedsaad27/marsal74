/** Shared class names for sidebar (dark navy + reference layout) */

export const sidebarParentBtn =
  "h-10 gap-3 rounded-md px-3 text-[13px] font-medium text-sidebar-foreground shadow-none hover:bg-sidebar-accent/70 hover:text-sidebar-accent-foreground data-[active=true]:bg-sidebar-primary data-[active=true]:font-semibold data-[active=true]:text-sidebar-primary-foreground data-[active=true]:shadow-glow";

export const sidebarStandaloneBtn =
  "h-10 gap-3 rounded-md px-3 text-[13px] font-medium text-sidebar-foreground shadow-none hover:bg-sidebar-accent/70 hover:text-sidebar-accent-foreground data-[active=true]:bg-sidebar-primary data-[active=true]:font-semibold data-[active=true]:text-sidebar-primary-foreground data-[active=true]:shadow-glow";
